...
def frames():
    ...
    a = [answers, answers2, answers3, answers4, answers5]
    a_form = [form.answer1.choices, form.answer2.choices, form.answer3.choices, form.answer4.choices,
              form.answer5.choices]
    for i, answer in a:
